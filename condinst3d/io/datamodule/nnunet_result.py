    ...
    def __init__(
        ...
        for case_name in case_names:
            case_dict = {
                ...
                "pred_softmax": os.path.join(pred_root, f"{case_name}.npz"),
                "pred_info": os.path.join(pred_root, f"{case_name}.pkl"),
            }
        ...
        self.collate_fn = partial(
            ...
            collate_keys=['inputs', 'instance_mask', 'semantic_mask', 'gt_onehot', 'gt_boxes', 'gt_classes',
                          'pred_instance_mask', 'pred_bin', 'pred_onehot', 'pred_boxes', 'pred_classes', 'pred_scores'],
            target_keys={
                "targets": {
